...
import Logo from './logoPiedraNegra.jpg';
import domain1 from './piedraNegra1.jpg';
import domain2 from './piedraNegra2.jpg';
import domain3 from './piedraNegra3.jpg';
import domain4 from './piedraNegra4.jpg';
...
const domainBousquet = () => {
  ...
  useEffect(() => {
    const mockVideos = [
      { id: 'video1', title: 'Video 1', url: 'https://youtu.be/watch?v=pzmusk1j-HA' },
      { id: 'video2', title: 'Video 2', url: 'https://youtu.be/watch?v=aEmkPzwPRxc' }, 
                ...
                <Center>
                  ...
                  >
                    <VStack
                      ...
                      align='stretch'
                    >
                      <h4>EL POTENCIAL DE UN GRAN TERRUÑO</h4>
                      <p style={{ fontSize: '18px' }}>
                        <i>Tras una larga búsqueda en varias regiones de Argentina, François Lurton decide implantar sus viñedos en unas tierras altas y semidesérticas (unas gravas pobres que recuerdan a las de Pessac-Léognan) en las llanuras a los pies de la cordillera de los Andes: el Valle de Uco.Estas tierras inexploradas se encuentran en el distrito de Los Chacayes, nombre que François Lurton dará a su grande cuvée.Nuestro pionero en el Valle de Uco construyó su bodega, la Bodega Piedra Negra, en 200 hectáreas de tierra virgen. Gracias a su experiencia, adquirida en todo el mundo, inmediatamente pone en práctica una viticultura respetuosa con el medio ambiente.</i>
                      </p>
                      <p style={{ fontSize: '18px' }}>
                      Gracias a las condiciones climáticas de este desierto en altura y a unos suelos de gravas aluviales muy drenantes y poco fértiles, los vinos del Valle de Uco, y en especial los de Los Chacayes, tienen una personalidad única que combina frescor y concentración. Hoy en día, el Valle de Uco es imprescindible y, sin duda, "la región vinícola de la que más se habla en Argentina e incluso en toda Sudamérica" en palabras de Tim Atkin, de la revista Decanter.
                      </p>
                      <p>
                      Cada uno de sus cuarteles se cultiva en función de unos criterios agronómicos precisos (fertilización, tamaño y estrés hídrico) para controlar el rendimiento y alcanzar unos objetivos de calidad determinados. Gran parte de la finca cuenta con un certificado ecológico, sin herbicidas ni productos fitosanitarios de síntesis.
                      </p>
